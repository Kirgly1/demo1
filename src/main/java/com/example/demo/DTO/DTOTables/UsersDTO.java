...
public class UsersDTO {
    ...
    public UsersDTO(String username, String password, String firstName, String lastName, boolean isActive, String imageUrl, Date created, Date modified, RolesDTO role) {
        this.username = username;
        this.password = password;
        this.firstName = firstName;
        this.lastName = lastName;
    ...
    public RolesDTO role(){return role;}
